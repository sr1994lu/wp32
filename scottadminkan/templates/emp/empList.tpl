...
<body>
  ...
  <section>
    <p>新規登録は<a href="/oh/wp32/scottadminkan/emp/goEmpAdd.php">こちら</a>から</p>
  </section>

  <section>
    <form action="/oh/wp32/scottadminkan/emp/showEmpList.php" method="get">
      従業員名を <input type="text" name="keyword" value="{$keyword|default:''}">で<input type="submit" value="検索">
    </form>
  </section>
    ...
    <table>
      ...
      {foreach from=$empList item='emp' name='empListLoop'}
        <tr>
          ...
          <td>
            <form action="/oh/wp32/scottadminkan/emp/prepareEmpEdit.php" method="post">
