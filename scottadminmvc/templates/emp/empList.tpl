...
<body>
  ...
  <section>
    <p>新規登録は<a href="/oh/wp32/scottadminmvc/emp/goEmpAdd.php">こちら</a>から</p>
  </section>
    ...
    <table>
      ...
      {foreach from=$empList item='emp' name='empListLoop'}
        <tr>
          ...
          <td>
            <form action="/oh/wp32/scottadminmvc/emp/prepareEmpEdit.php" method="post">
              <input type="hidden" id="editEmpEmpno" name="editEmpEmpno" value="{$emp->getEmpno()}">
              <input type="submit" value="編集">
            </form>
          </td>
          <td>
            <form action="/oh/wp32/scottadminmvc/emp/connfirmEmpDelete.php" method="post">
